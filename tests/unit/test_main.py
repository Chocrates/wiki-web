...
spiderStub = type('',(object,),{})()
spiderStub.buildNode = lambda x, y, z: (x, y, z)

trueUrlValidatorStub = lambda x: True
falseUrlValidatorStub = lambda x: False
...
class TestMain(unittest.TestCase):
    ...
    def test_3_arguments_throws_value_error(self):
        ...
        assert_that(calling(main.getNodes).with_args(spiderStub,trueUrlValidatorStub,input_args),raises(ValueError))
    ...
    def test_invalid_url_throws_value_error(self):
        ...
        assert_that(calling(main.getNodes).with_args(spiderStub,falseUrlValidatorStub,input_args),raises(ValueError))
